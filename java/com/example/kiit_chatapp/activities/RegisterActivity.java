...
public class RegisterActivity extends AppCompatActivity {
    ...
    private ImageButton viewConfirmPasswordButton, viewPasswordButton;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewConfirmPasswordButton = findViewById(R.id.viewConfirmPasswordButton);
        ...
        viewPasswordButton.setOnClickListener(v -> {
            ...
            if (passwordVisible) {
                ...
                viewPasswordButton.setImageResource(R.drawable.visible_off);
            } else {
                passwordEditText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
                passwordEditText.setSelection(passwordEditText.getText().length());
                viewPasswordButton.setImageResource(R.drawable.visible_on);
            }
        });

        viewConfirmPasswordButton.setOnClickListener(v -> {
            confirmPasswordVisible=!confirmPasswordVisible;
            if (confirmPasswordVisible) {
                confirmPasswordEditText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD);
                confirmPasswordEditText.setSelection(confirmPasswordEditText.getText().length());
                viewConfirmPasswordButton.setImageResource(R.drawable.visible_off);
            } else {
                confirmPasswordEditText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
                confirmPasswordEditText.setSelection(confirmPasswordEditText.getText().length());
                viewConfirmPasswordButton.setImageResource(R.drawable.visible_on);
            }
        });
    }
    ...
    private void registerUser() {
        ...
        if (firebaseUser != null && firebaseUser.isEmailVerified()) {
            db.collection("users").document(firebaseUser.getUid())
                    .get()
                    .addOnSuccessListener(documentSnapshot -> {
                        // --- Always set admin=false on registration ---
                        Map<String, Object> userMap = new HashMap<>();
                        userMap.put("uid", firebaseUser.getUid());
                        userMap.put("email", firebaseUser.getEmail());
                        userMap.put("admin", false); // <--- Always add this field!
