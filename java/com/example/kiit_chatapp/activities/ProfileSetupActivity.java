...
public class ProfileSetupActivity extends AppCompatActivity {
    ...
    private void saveProfile() {
        ...
        // Fetch current admin status before writing
        usersRef.child(currentUserId).child("admin").get().addOnCompleteListener(taskSnapshot -> {
            boolean isAdmin = false;
            if (taskSnapshot.isSuccessful() && taskSnapshot.getResult() != null) {
                Object adminObj = taskSnapshot.getResult().getValue();
